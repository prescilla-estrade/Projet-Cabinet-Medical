...
if (count($resultat) > 0) {
    ...
    $req = $linkpdo->prepare('INSERT INTO usagers(civilite, nom, prenom, adresse, date_de_naiss,
    lieu_de_naiss, num_securite_sociale) VALUES(:civilite, :nom, :prenom, :adresse, :date_de_naiss, :lieu_de_naiss, :num_securite_sociale)');
