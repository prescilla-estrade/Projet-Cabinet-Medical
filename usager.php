...
<html>
    ...
    <body>
        ...
        <h1>Usagers</h1>
        <button><a class="bouton-link" href="ajouter_usager.php">Ajouter Usager <i class="fas fa-plus"></i></a></button>
        <button><a class="bouton-link" href="liste_usagers.php">Liste des Usagers <i class="fas fa-user"></i></a></button>
